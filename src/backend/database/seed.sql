-- ========================================================
-- CICATA Docs — Seed Data
-- Run AFTER DDL-CICATA.sql (statusCatalog already seeded)
-- Admin password must be hashed at app level — see seed.ts
-- ========================================================
...
-- ── 5. Admin ─────────────────────────────────────────
-- Password placeholder — seed.ts will UPDATE with bcrypt hash
INSERT INTO admin (userId, username, password, email) VALUES
  (1, 'admin', '__PLACEHOLDER__', 'admin@cicata.ipn.mx');
