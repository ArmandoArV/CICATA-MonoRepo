...
CREATE TABLE letterheadConfig (
    ...
    watermark           MEDIUMBLOB   NULL COMMENT 'Optional watermark overlay image',
    headerBarColor      VARCHAR(7)   NOT NULL DEFAULT '#8B1832' COMMENT 'Footer line hex color',
    accentColor         VARCHAR(7)   NOT NULL DEFAULT '#591020' COMMENT 'Footer text hex color',
    footerText          TEXT         NULL     COMMENT 'Custom footer text (NULL = default)',
    folioPrefix         VARCHAR(100) NOT NULL DEFAULT 'SIP-DI-DDCYT-CICATAMOR-' COMMENT 'Folio prefix',
    cityLocation        VARCHAR(100) NOT NULL DEFAULT 'Xochitepec, Morelos' COMMENT 'Date-line location',
    footerLineThickness DECIMAL(3,1) NOT NULL DEFAULT 1.8  COMMENT 'Footer line pt thickness',
    logoHeaderW         INT          NOT NULL DEFAULT 350  COMMENT 'Logo header width in pt',
    logoHeaderH         INT          NOT NULL DEFAULT 65   COMMENT 'Logo header height in pt',
    topRightW           INT          NOT NULL DEFAULT 90   COMMENT 'Top-right width in pt',
    topRightH           INT          NOT NULL DEFAULT 90   COMMENT 'Top-right height in pt',
    footerBottomW       INT          NOT NULL DEFAULT 80   COMMENT 'Footer image width in pt',
    footerBottomH       INT          NOT NULL DEFAULT 80   COMMENT 'Footer image height in pt',
    marginLeft          INT          NOT NULL DEFAULT 72   COMMENT 'Page left margin in pt',
    marginRight         INT          NOT NULL DEFAULT 72   COMMENT 'Page right margin in pt',
    marginTop           INT          NOT NULL DEFAULT 72   COMMENT 'Page top margin in pt',
    marginBottom        INT          NOT NULL DEFAULT 72   COMMENT 'Page bottom margin in pt',
